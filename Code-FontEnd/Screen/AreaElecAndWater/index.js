...
import { AreaElectricAndWater } from "../../component";
import { fetchListArea } from "../../store/slices/area";
import { useSelector, useDispatch } from "react-redux";
import Loading from "../../component";
import { useNavigation } from "@react-navigation/native";

const AreaElectricAndWaterScreen = () => {
  ...
  const renderArea = ({item}) => {
    return <AreaElectricAndWater data={item}/>;
  };
...
export default AreaElectricAndWaterScreen;
