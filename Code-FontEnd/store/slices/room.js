...
export const fetchCreateRoom = createAsyncThunk(
  ...
  async (data, thunkAPI) => {
    const { Describe, NameRoom, Status, Date_created,idKhu,NumberLimit,Floor } = data.data;
...
export const fetchUpdateRoom = createAsyncThunk(
  ...
  async (data, thunkAPI) => {
    const { Describe, NameRoom, Status, Date_created,NumberLimit,Floor,idPhong,idKhu } = data.data;
