...
const Room = ({ data }) => {
  ...
  const handleDelete = () => {
    Alert.alert(
      "Thông báo",
      "Bạn có muốn xóa phòng",
      [
        { text: "Đồng ý", onPress: () => {
          dispatch(fetchDeleteRoom({dataRoom:{idPhong: data.idPhong,idKhu: data.idKhu,Floor: data.Tang}}))
        }}
        ,
        {
          text: "Hủy",
  ...
  return (
    <TouchableOpacity style={styles.container} onPress={handleClick} onLongPress={handleDelete}>
